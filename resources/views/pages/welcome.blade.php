      ...
      <div class="row align-items-center">
            ...
            <div class="col-5">
                  ...
                  <p>
                        ...
                        <strong>Iniziamo subito!</strong> Che cosa vuoi fare?
                  </p>
                  <a class="btn btn-main me-3 px-4 py-2" href="{{route('homepage')}}">Home</a>
                  <a class="btn btn-outline px-4 py-2" href="{{route('announcements.create')}}">Crea annuncio</a>
