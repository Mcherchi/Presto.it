 <div class="row align-items-center">
    <div class="col-12 col-md-10 row">
            <form id="form-search" class="form-floating col-12 col-md mb-3 me-3" action="{{route('announcements.search')}}" method="GET">
                ...
                <label class="px-3 py-2 small" for="searchInput">Cerca</label>
            </form>
        <div class="form-floating col-12 col-md mb-3">                               
            ...
            <label class="p-3">Seleziona Categoria</label>
        </div> 
    </div> 
    <div class="col-12 col-md-2">
        <button type="submit" id="submit-btn" class="btn btn-lg btn-dark w-100 py-3 mb-3">Cerca</button>
    </div>                 
</div>